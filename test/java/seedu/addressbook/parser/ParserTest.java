...
public class ParserTest {
    ...
    public void parse_addCommandInvalidArgs_errorMessage() {
        final String[] inputs = {
            ...
            // no phone prefix
            String.format("add $s $s e/$s b/$s a/$s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE,
                    Birthday.EXAMPLE, Address.EXAMPLE),
            // no email prefix
            String.format("add $s p/$s $s b/$s a/$s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE,
                    Birthday.EXAMPLE, Address.EXAMPLE),
            // no address prefix
            String.format("add $s p/$s e/$s b/$s $s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE,
                    Birthday.EXAMPLE, Address.EXAMPLE)
        };
    ...
    public void parse_addCommandInvalidPersonDataInArgs_errorMessge() {
        ...
        final String invalidBirthdayArg = "b/not_8_numbers";
